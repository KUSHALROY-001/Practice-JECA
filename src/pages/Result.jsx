...
const Result = () => {
  ...
  const { questions, answers, year, topic } = state;
    ...
    <div className="w-full max-w-4xl mx-auto space-y-6">
      <div className="bg-white/80 backdrop-blur-md p-8 rounded-3xl shadow-lg shadow-indigo-100/50 border border-white/60 text-center">
        ...
        <p className="text-slate-500 text-lg font-medium">
          {year ? `JECA Year ${year}` : `Topic: ${topic}`}
        </p>
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-4 mt-10">
          ...
          <div className="p-6 bg-green-50 rounded-2xl border border-green-100">
            <div className="text-sm font-bold text-green-600/70 uppercase tracking-widest mb-1">
              Correct
            </div>
          ...
          <div className="p-6 bg-red-50 rounded-2xl border border-red-100">
            <div className="text-sm font-bold text-red-600/70 uppercase tracking-widest mb-1">
              Wrong
            </div>
          ...
          <div className="p-6 bg-rose-50 rounded-2xl border border-rose-200">
            <div className="text-sm font-bold text-rose-500/80 uppercase tracking-widest mb-1">
              Negative
            </div>
          ...
          <div className="p-6 bg-orange-50 rounded-2xl border border-orange-100">
            <div className="text-sm font-bold text-orange-600/70 uppercase tracking-widest mb-1">
              Unattempted
            </div>
      ...
      <div className="bg-white/80 backdrop-blur-md p-8 rounded-3xl shadow-sm border border-slate-100">
